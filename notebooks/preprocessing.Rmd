...
```{r}
datos <- medi_reexp |>
  left_join(trgsf_guilt, by = c("ID", "session", "condition", "intervention", "component", "component_order")) |>
  left_join(trssf_shame, by = c("ID", "session", "condition", "intervention", "component", "component_order")) |>
  left_join(fscrs_selfhatred, by = c("ID", "session", "condition", "intervention", "component", "component_order")) |>
  left_join(fscrs_selfinadequacy, by = c("ID", "session", "condition", "intervention", "component", "component_order")) |>   left_join(fscrs_reassurance, by = c("ID", "session", "condition", "intervention", "component", "component_order"))
```

```{r}
datos <- datos |> select(ID, MEDI, guilt_trgsf, shame_trssf, self_hatred, self_inadequacy, self_reassurance, session,  condition, intervention, component, component_order)
```
